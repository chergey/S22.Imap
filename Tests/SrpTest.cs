...
namespace S22.Imap.Test {
	...
	public class SrpTest {
		...
		public void SerializeClientSecondMessage() {
		    ...
		    ClientMessage2 m = new ClientMessage2(_publicKey, clientProof) {InitialVector = clientInitialVector};
		...
		static byte[] expectedClientMessage2 = {
		...
		static byte[] expectedClientFirst = {
		...
		static byte[] expectedClientSecond = {
